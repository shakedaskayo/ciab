...
4. For sandbox creation: the **provisioning pipeline** executes 9 steps, streaming each over SSE
...
- **Runtime-flexible**: Local process is the default — no Docker needed. Docker and OpenSandbox are pluggable backends for stronger isolation.
